...
class Xchange_config_page(Base_page):
    ...
    def __init__(self, driver):
        ...
        # Add Xchange Rate config
        self.Xchange_config_click_xpath = "//a[@routerlink='/xchange-config']"
        self.XC_rate_addconfig_click_xpath = "//body/app-root/div/app-exchange-rate-page/div/div/div/button[@type='button']/span[2]"
        self.XC_FC_click_xpath = "//select[@formcontrolname='fromCurrencyCode']"  # From Currency
        self.XC_TC_click_xpath = "//select[@formcontrolname='toCurrencyCode']"   # TO Currency
        self.XC_rate_xpath = "//input[@id='validationCustomUsername']"
        self.addXCconfig_savebutton_click_xpath = "//button[@type='submit']"
        ...
        self.XC_gsearchbar_xpath = "//body[1]/app-root[1]/div[1]/app-exchange-rate-page[1]/div[1]/p-table[1]/div[1]/div[1]/div[1]/div[1]/div[1]/input[1]"
        # small search bars
        self.XC_S_id_xpath = "//th[1]//input[1]"
        self.XC_S_FCC_xpath = "//th[2]//input[1]"
        self.XC_S_TCC_xpath = "//th[3]//input[1]"
        self.XC_S_Rate_xpath = "//th[4]//input[1]"
        # Actions
        # Edit
        self.XC_editB_xpath = "//body[1]/app-root[1]/div[1]/app-exchange-rate-page[1]/div[1]/p-table[1]/div[1]/div[2]/div[1]/" \
                              "div[2]/table[1]/tbody[1]/tr[1]/td[5]/button[1]"
        self.setDefault_button_xpath =  "//tbody/tr[1]/td[5]/button[3]/span[1]"

        # Delete
        self.XC_deleteB_xpath = "//body[1]/app-root[1]/div[1]/app-exchange-rate-page[1]/div[1]/p-table[1]/" \
                                "div[1]/div[2]/div[1]/div[2]/table[1]/tbody[1]/tr[1]/td[5]/button[2]"
        #e/d ok
        self.XC_e_d_ok_button_xpath = "//ngb-modal-window[@role='dialog']//button[2]"
# Clicks
